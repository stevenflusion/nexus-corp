...
import { loadSharedPdfEngine } from "@workspace/ui/components/pdf-thumbnail-utils"
...
function PDFViewerSkeletonPage() {
  return (
    <div className="flex w-full flex-col items-center gap-6 px-8 py-10">
      <div className="flex w-full max-w-[210mm] flex-col gap-5 rounded-sm border border-[var(--nexus-line)] bg-[var(--nexus-paper)] p-8 shadow-sm">
        <div className="flex items-center gap-3">
          <div className="h-4 w-32 animate-pulse rounded-md bg-[var(--nexus-line)]/50" />
          <div className="h-4 w-48 animate-pulse rounded-md bg-[var(--nexus-line)]/30" />
        </div>
        <div className="h-3 w-full animate-pulse rounded-md bg-[var(--nexus-line)]/40" />
        <div className="h-3 w-3/4 animate-pulse rounded-md bg-[var(--nexus-line)]/40" />
        <div className="h-3 w-5/6 animate-pulse rounded-md bg-[var(--nexus-line)]/30" />
        <div className="h-3 w-2/3 animate-pulse rounded-md bg-[var(--nexus-line)]/40" />
        <div className="h-3 w-4/5 animate-pulse rounded-md bg-[var(--nexus-line)]/30" />
        <div className="h-3 w-3/5 animate-pulse rounded-md bg-[var(--nexus-line)]/40" />
        <div className="mt-4 h-px w-full bg-[var(--nexus-line)]/20" />
        <div className="h-3 w-5/6 animate-pulse rounded-md bg-[var(--nexus-line)]/30" />
        <div className="h-3 w-2/3 animate-pulse rounded-md bg-[var(--nexus-line)]/40" />
        <div className="h-3 w-4/5 animate-pulse rounded-md bg-[var(--nexus-line)]/30" />
        <div className="h-3 w-full animate-pulse rounded-md bg-[var(--nexus-line)]/40" />
        <div className="h-3 w-3/4 animate-pulse rounded-md bg-[var(--nexus-line)]/30" />
      </div>
    </div>
  )
}
...
function PDFViewerLoadingSkeleton({
  ...
  return (
    <div className="absolute inset-0 z-20 flex overflow-y-auto bg-[var(--nexus-cream)]">
      {sidebarOpen ? (
        <DocumentViewerSidebarSkeleton
