...
function Pagination({
  ...
  return (
    <div
      data-slot="magic-link-pagination"
    ...
    >
      ...
      <div className="flex items-center gap-3">
        <div className="flex items-center gap-2">
          ...
          >
            <SelectTrigger
              data-slot="magic-link-pagination-per-page"
              className="w-20"
            >
              <SelectValue />
            </SelectTrigger>
        ...
        <div className="flex items-center gap-1">
          <Button
            data-slot="magic-link-pagination-previous"
            variant="outline"
            size="icon-sm"
          ...
          <span
            data-slot="magic-link-pagination-info"
            className={cn(
          ...
          <Button
            data-slot="magic-link-pagination-next"
            variant="outline"
            size="icon-sm"
            onClick={() => onPageChange(currentPage + 1)}
